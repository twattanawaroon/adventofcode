...
ops = [addi, bani, gtir, borr, eqrr, bori, gtrr, setr, muli, seti, banr, gtri, eqir, eqri, addr, mulr, divi]
opmap = dict()
for op in ops:
...
ans = None
ip = 0
# replace input line 18, first parameter to 18
# replace input lines with 19-28 with "divi 5 256 5"
while ip < len(instrs):
    x[ipc] = ip
